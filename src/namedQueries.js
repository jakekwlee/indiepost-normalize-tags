module.exports = {
  ...
  SELECT_POST_IDS_BY_TAG_IDS: 'select distinct postId from Posts_Tags where tagId in (?)',
  UPDATE_POSTS_TAGS: 'update Posts_Tags set tagId = ? where tagId = ? and id > 0',
  UPDATE_POST_LAST_UPDATED: 'update Posts set modifiedAt = now(), editorId = 1 where id in (?)',
